...
package crypto.srtp.retained;
import java.util.Arrays;
import crypto.srtp.retained.ResponderRetainedSecretsCalculator;
/**
...
public class InitiatorRetainedSecretsCalculator extends crypto.srtp.retained.RetainedSecretsCalculator {

  private static final String ROLE = "Initiator";

  public InitiatorRetainedSecretsCalculator(crypto.srtp.retained.RetainedSecrets retainedSecrets) {
