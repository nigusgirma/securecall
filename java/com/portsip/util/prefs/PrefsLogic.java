...
package com.portsip.util.prefs;
...
import com.portsip.util.PreferencesProviderWrapper;
import com.portsip.util.PreferencesWrapper;
import com.portsip.util.SipConfigManager;
...
public class PrefsLogic {
    ...
    public static int getXmlResourceForType(int t) {
        switch(t) {
            case TYPE_MEDIA:
                return 0;//R.xml.prefs_media;
            case TYPE_MEDIA_BAND_TYPE:
                return 0;//R.xml.prefs_media_band_types;
            case TYPE_MEDIA_TROUBLESHOOT:
                return 0;//R.xml.prefs_media_troubleshoot;
            case TYPE_NETWORK:
                return R.xml.prefs_network;
            case TYPE_NETWORK_KEEP_ALIVE:
                return 0;//return R.xml.prefs_network_keep_alive;
            case TYPE_NETWORK_SECURE:
                return 0;//return R.xml.prefs_network_secure;
            case TYPE_NETWORK_SIP_PROTOCOL:
                return 0;//return R.xml.prefs_network_sip_protocol;
            case TYPE_CALLS:
                return 0;//return R.xml.prefs_calls;
            case TYPE_UI:
                return 0;//return R.xml.prefs_ui;
        }
        return 0;
    }
